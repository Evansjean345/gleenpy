...
const ObjTrailer = {
  videoTrailer:
    "https://i1.sndcdn.com/avatars-fhQnbBzXfesUjzOe-EfaUSA-t500x500.jpg",
  title: "Ziak",
  text: "Fixette",
  videoModal: "https://www.youtube-nocookie.com/embed/MqiljVyq_1o" ,
};

const SecondObj = {
  title: "Lyrics",
  text: `Han, عندي السم في الدم (السم)
  ...
  La mort est surprise, ça t'rend paro, on dit qu'j'suis pas bon pour les cadeaux
  ...
  On sort le Kala', on fait not' boulot (haha)`
};
