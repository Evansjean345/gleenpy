...
const ObjTrailer = {
  ...
  title: "Dinos X Damso",
  text: "Du mal à te dire",
  videoModal: "https://www.youtube-nocookie.com/embed/cMxDTANZRWc",
};
...
const SecondObj = {
  ...
  Tu voulais démarrer, j'voulais rapper ma vie, tu voulais t'évader, j'voulais la Ferrari
  J'suis devenu trop dangereux comme le vice de ma rue
  J'm'en vais pour mieux revenir comme le fils de Marie (Alléluia)
  
  [Pont : Dinos]
  Les p'tits savent même plus penser, comme si les études ça f'sait même plus manger
