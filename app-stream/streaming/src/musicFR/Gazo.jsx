...
const ObjTrailer = {
  videoTrailer:
    "https://c.tenor.com/3m4IMOzkXwQAAAAC/kassav-merci-aux-clients-fid%C3%A8les.gif",
  title: "Gazo",
  text: "Die",
  videoModal: "https://www.youtube-nocookie.com/embed/AHAcwzQJS4M",
};

const SecondObj = {
  title: "Lyrics",
  text: `La mala est gangx
  Eh
  (Bang-bang) Eh
  Le bang-bang
