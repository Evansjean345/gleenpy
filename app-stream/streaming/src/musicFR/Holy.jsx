...
const ObjTrailer = {
  videoTrailer:
   "https://dorhema.com/uploads/artist/13/artist-melody-nvt-1640266377-large.jpeg",
  title: "Melody NVT",
  text: "Holy Spirit",
  videoModal:"https://www.youtube-nocookie.com/embed/KqnAuERZ8-w"
};

const SecondObj = {
  title: "Lyrics",
  text: `Descend eh, descend
  Holy descend, eh
  Holy spirit descend, eh, descend, eh
  Holy descends, eh, descend, eh
  Holy spirit descend, eh, descend eh
  Holy descend eh, descend eh
  Papa descend, eh, descend, eh
  Descend eh, papa descend
  Holy spirit descend, eh, descends eh
  Holy descend eh, descends eh
  De-descend, eh, de-descend, eh
  De-descends, eh, descend
  Papa de-descend, Papa de-descend
  Pa de-descend, eh, descend eh`,
};
