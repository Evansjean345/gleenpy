...
const ObjTrailer = {
  videoTrailer:
    "https://64.media.tumblr.com/97133998cbc50424aa960b98e4a9b6ca/tumblr_mrw8c5B0h21sekdnao2_500.gifv",
  title: "5 centimètres par seconde",
  text: "5 centimètres par seconde raconte la relation entre deux personnages, Takaki et Akari. Leur amitié d'enfance évolue en histoire d'amour, malheureusement contrariée...",
  videoModal: "https://www.dailymotion.com/embed/video/x18dsh9",
};

const SecondObj = {
  title: "5 centimètres par seconde",
  text: `À l’arrivée d’Akari Shinohara, Takaki Tono se lie rapidement d'amitié avec elle, en raison de leurs intérêts communs, par exemple, les deux préfèrent rester à l'intérieur pendant la récréation à cause de leurs allergies saisonnières. Dans la version japonaise on s’aperçoit que le registre que l’un et l’autre utilisent pour parler souligne le lien solide qui les unit ce qui est très inhabituel au Japon, même parmi les gens qui sont amoureux.`,
};
