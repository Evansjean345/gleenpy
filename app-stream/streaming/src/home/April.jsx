...
const ObjTrailer = {
  videoTrailer: "https://media.tenor.com/bcvK_rU5voEAAAAC/anime-piano.gif",
  title: "Your lie in April",
  text: "Un prodige du piano qui a perdu sa capacité à jouer après avoir subi un événement traumatisant dans son enfance est repoussé sous les projecteurs par une fille excentrique avec un secret qui lui est propre.",
  videoModal: "https://www.dailymotion.com/embed/video/x3nd1z1",
};

const SecondObj = {
  title: "Your lie in April",
  text: "Arima Kōsei est un jeune pianiste de renom. Petit prodige depuis son plus jeune âge, communément appelé « métronome humain », il excelle dans toutes les compétitions auxquelles il participe en donnant une prestation reproduisant avec exactitude une partition. Cependant, sa mère qui est à la fois pianiste et son professeur décède subitement des suites d'une grave maladie dont les causes sont inconnues et Kōsei rate un concours qui aurait pu le conduire à jouer du piano à l'international. Il abandonne de ce fait le piano et tout son passé.",
};
