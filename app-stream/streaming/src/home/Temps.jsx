...
const ObjTrailer = {
  videoTrailer: "https://brightopenworld.files.wordpress.com/2019/12/tenki-no-ko-anime-gif.gif?w=500",
  title: "Les enfants du Temps",
  text:  "Jeune lycéen, Hodaka fuit son île pour rejoindre Tokyo. il tente de survivre dans la jungle urbaine et trouve un poste dans une revue dédiée au paranormal.",
  videoModal: "https://www.dailymotion.com/embed/video/x7p8yma",
};
...
export default LesEnfantsDuTemps;
