...
const ObjTrailer = {
  videoTrailer: "https://c.tenor.com/F2feYbycPbIAAAAd/violet-evergarden-anime.gif",
  title: "Violet Evergarden",
  text:  "Violet Evergarden raconte l'histoire d'une enfant-soldat de 14 ans. Orpheline recueillie par un militaire lors d'un conflit terrible dans une Europe fantasmée par l'imaginaire japonais.",
  videoModal: "https://www.dailymotion.com/embed/video/x84d75z" ,
};

const SecondObj = {
  title: "Violet Evergarden",
  text:`L'histoire se déroule autour d'une jeune fille qui effectue le métier de « poupées de souvenirs automatiques » : des poupées initialement créées par le professeur Orland pour aider sa femme aveugle Mollie à écrire ses romans, et plus tard louées à d'autres personnes qui avaient besoin de leurs services.`
};

function VioletEvergarden() {
