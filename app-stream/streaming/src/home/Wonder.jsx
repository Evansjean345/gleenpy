...
const ObjTrailer = {
  videoTrailer:
    "https://c.tenor.com/bJjyhJgw-wwAAAAC/wonder-egg.gif",
  title: "Wonder eggs priority",
  text: "Ai Ohto, une jeune fille de 14 ans, entend une voix mystérieuse l'appeler alors qu'elle se promène en ville tard la nuit.",
  videoModal: "https://www.dailymotion.com/embed/video/x86icbl",
};
...
export default WonderEggsPriority;
