...
const ObjTrailer = {
  videoTrailer: "https://republiquedujapap.com/wp-content/uploads/2022/09/FB_IMG_1663679835196.jpg?ezimgfmt=ng%3Awebp%2Fngcb18",
  title: `Emma Lohoues`,
  text: `SORTEZZZ Emma Lohoues en colère répond à Carmen Sama en direct`,
  videoModal:"https://www.youtube-nocookie.com/embed/PY7DyVjQjDA"
};
...
export default function  Lohoues() {
          ...
          <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col">
              ...
              <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                ...
                <p class="sm:w-3/5 leading-relaxed  font-bold sm:pl-10 pl-0">
                  {SecondObj.text}
                </p>
              </div>
            </div>
