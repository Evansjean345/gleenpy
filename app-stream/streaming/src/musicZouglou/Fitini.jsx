...
const ObjTrailer = {
  videoTrailer: "https://media-files.abidjan.net/photo/FITINI%20(23).JPG",
  title: "Fitini le créateur",
  text: "contrat sacrifice",
  videoModal: "https://www.youtube-nocookie.com/embed/mfgVem1C0y8",
};
...
export default function Fitini() {
