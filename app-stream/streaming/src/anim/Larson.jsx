...
const ObjTrailer = {
  videoTrailer: "https://c.tenor.com/mzk102g9Ke4AAAAC/underwear-city-hunter.gif",
  title: "Nicky Larson",
  text: "Nicky Larson, garde du corps et détective privé, ne peut s'empêcher de séduire les femmes. Sa technique laisse insensible Laura, sa partenaire.",
  videoModal: "https://www.dailymotion.com/embed/video/x5gzw9",
};

const SecondObj = {
  title: "City Hunter",
  text: "Tony Marconi (de son vrai nom Hideyuki Makimura), un ancien policier devenu détective privé, est associé à l'un de ses amis qui est également détective privé et garde du corps hors normes, Nicky Larson (Ryô Saeba), et continue en parallèle certaines de ses enquêtes. Un jour Nicky fait la rencontre d'une jeune femme qui n'est autre que la sœur de Tony, Laura Marconi (Kaori Makimura) ; ce moment devient le point de départ de leur relation9."
};

const naruto1 = [
  { url: "https://www.dailymotion.com/embed/video/x5gzw9", season: "saison 1" },
  { url: "https://www.dailymotion.com/embed/video/x40ay3", season: "saison 1" },
];
const naruto2 = [
  {
    url:"https://www.dailymotion.com/embed/video/x5h01u",
    season: "saison 2",
  },
  {
    url:"https://www.dailymotion.com/embed/video/xdhrxp",
    season: "saison 2",
  },
