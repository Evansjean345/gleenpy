...
const ObjTrailer = {
  videoTrailer:
    "https://i.pinimg.com/originals/b8/15/24/b81524efb1dfb43f2f0eec62e6a91cc0.gif",
  title: "Demon Slayer",
  text: "Le groupe de Tanjirô a terminé son entraînement de récupération au domaine des papillons et embarque à présent en vue de sa prochaine mission à bord du train de l'infini.",
  videoModal: "https://www.dailymotion.com/embed/video/x89npwg",
};

const SecondObj = {
  title: "Demon Slayer",
  text: `Dans un Japon de l'ère Taishō, Tanjirō Kamado est le premier enfant d'une famille de marchands de charbon dont le père est décédé : pour subvenir aux besoins de celle-ci, il vend du charbon de bois au village en contrebas de la montagne. Malgré les difficultés de la vie, ils réussissent à trouver un peu de bonheur dans leur quotidien.`,
};

const naruto1_2 = [
  {
    url: "https://www.dailymotion.com/embed/video/x8dy9mw",
    season: "saison 1",
  },
  {
    url: "https://www.dailymotion.com/embed/video/x89nu3e" ,
    season: "saison 1",
  },
];
const naruto3_4 = [
  {
    url: "https://www.dailymotion.com/embed/video/x89nw2d",
    season: "saison 2",
  },
];
