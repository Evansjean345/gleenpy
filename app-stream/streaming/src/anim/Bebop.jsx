...
const ObjTrailer = {
  videoTrailer: "https://c.tenor.com/Yw1GVmu7GAsAAAAd/cowboy-bebop-spike-spiegel.gif",
  title: "Cowboy Bebop",
  text: "Sur la planète Mars, en 2071, un camion-citerne explose. Aux victimes tuées par l'explosion s'ajoutent des personnes qui succombent à une mystérieuse maladie.",
  videoModal: "https://www.dailymotion.com/embed/video/x5gf1hw",
};

const SecondObj = {
  title: "Cowboy Bebop",
  text: "Cette série de science-fiction suit les aventures d'un groupe de chasseurs de primes voyageant dans un vaisseau spatial, le Bebop, en 2071. Elle est réalisée dans un style fortement influencé par la culture cinématographique américaine."
};

const naruto1 = [
  { url: "https://www.dailymotion.com/embed/video/x5gf1hw", season: "saison 1" },
];
