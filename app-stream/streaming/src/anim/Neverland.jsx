...
const ObjTrailer = {
  videoTrailer: "https://sushiiiwithsoysauce.com/wp-content/uploads/2020/10/tpn.gif",
  title: "The Promised Neverland",
  text: "Emma et ses frères et sœurs, tous orphelins, ont été placés dans un établissement spécialisé lorsqu'ils étaient tout jeunes. Bien que leur liberté soit limitée et que les règles soient parfois un peu strictes .",
  videoModal: "https://www.dailymotion.com/embed/video/x88abeh",
};

const SecondObj = {
  title: "The Promised Neverland",
  text: "Emma, Norman et Ray coulent des jours heureux à l'orphelinat Grace Field House. Entourés de leurs petits frères et soeurs, ils s'épanouissent sous l'attention pleine de tendresse de « Maman », qu'ils considérent comme leur véritable mère."
};

const naruto1 = [
  { url: "https://www.dailymotion.com/embed/video/x88abeh", season: "saison 1" },
];
const naruto2 = [
  {
    url: "https://www.dailymotion.com/embed/video/x7yvm4w",
    season: "saison 2",
  },
];
