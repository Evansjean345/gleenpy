...
const ObjTrailer = {
  videoTrailer:
    "https://c.tenor.com/NXHN9kfV4zQAAAAd/asta.gif",
  title: "Black Clover",
  text:   "Dans un monde régi par la magie, Yuno et Asta ont grandi ensemble avec un seul but en tête : devenir le prochain Empereur-Mage du royaume de Clover.",
  videoModal: "https://www.dailymotion.com/embed/video/x7mau2c",
};

const SecondObj = {
  title: "Black Clover",
  text: `Asta est un jeune garçon déterminé qui vit avec son ami d’enfance, Yuno, dans un orphelinat du royaume de Clover. Depuis tout petit, Asta a pour ambition de devenir le magicien le plus puissant du royaume, "l’Empereur-Mage", ce qui a aussi inspiré Yuno à vouloir la même chose. Mais malheureusement, Asta est né sans aucun talent magique, alors que Yuno possède des prédispositions spectaculaires.`
};

const naruto1_2 = [
  { url:"https://www.dailymotion.com/embed/video/x7mau2c" , season: "saison 1" },
  {
    url: "https://www.dailymotion.com/embed/video/x7obtca" ,
    season: "saison 1",
  },
  {
    url:"https://www.dailymotion.com/embed/video/x7zbyp1"  ,
    season: "saison 2",
  },
];
const naruto3_4 = [
  {
    url: "https://www.dailymotion.com/embed/video/x7la48m",
    season: "saison 3",
  },
  {
