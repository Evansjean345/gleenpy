...
const ObjTrailer = {
  videoTrailer:
    "https://thumbs.gfycat.com/DimwittedMassiveEsok-size_restricted.gif",
  title: "Corazón valiente",
  text:"Il s'agit du destin croisé d'Angela et Samantha, meilleures amies d'enfance, devenues gardes du corps.",
  videoModal:"https://www.youtube-nocookie.com/embed/dVOoV9lpNTM",
};

const SecondObj = {
  title: "Corazón valiente",
  text: ` Il s'agit du destin croisé d'Angela et Samantha, meilleures amies d'enfance, devenues gardes du corps. Elles vont devoir mener deux combats à la fois : protéger leurs clients et contrer tous ceux qui les empêchent d'accéder au bonheur. Angela est la fille d'un modeste garde du corps, Miguel Valdez Sr.
  `,
};

export default function Corazón() {
