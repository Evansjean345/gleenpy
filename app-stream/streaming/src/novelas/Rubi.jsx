...
const ObjTrailer = {
  videoTrailer:
    "https://64.media.tumblr.com/7fe34522274979e2cc4d65234d06ca42/tumblr_inline_nw4tplNmZj1rwjmmy_400.gifv",
  title: "Rubi",
  text: `Rubí (Bárbara Mori) est une jolie fille qui vit avec sa mère, Raphaëlle (Refugio VE) et sa sœur, Cristina.`,
  videoModal:"https://www.youtube-nocookie.com/embed/uYJvCTfmhEY",
};

const SecondObj = {
  title: "Rubi",
  text: ` Rubí (Bárbara Mori) est une jolie fille qui vit avec sa mère, Raphaëlle (Refugio VE) et sa sœur, Cristina. Sa mère est une femme réservée, travailleuse et traditionnelle et son seul désir est de voir ses filles mener une vie simple et tranquille. Elle aime ses deux filles mais se sent plus proche de Christina ...`,
};

export default function Rubi() {
