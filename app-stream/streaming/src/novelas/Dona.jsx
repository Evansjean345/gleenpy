...
const ObjTrailer = {
  videoTrailer:
    "https://64.media.tumblr.com/4be9d841a4b86a51e67a4daaa9359cb7/21e8f1946d384bf7-76/s540x810/201cbff2627b2dd888e4f13760f358559540a446.gifv",
  title: "La Doña",
  text:"La Doña est une histoire de vengeance et d'ambition, de séduction et de trahison.",
  videoModal:"https://www.youtube-nocookie.com/embed/ouryrc9c5Kg",
};

const SecondObj = {
  title: "La Doña",
  text: `La Doña est une histoire de vengeance et d'ambition, de séduction et de trahison, qui tourne autour d'une femme offensée du nom d'Altagracia Sandoval, victime de violence avec un triste passé. Lorsqu'elle et sa sœur Regina étaient adolescentes, leurs parents et son petit ami ont été assassinés.
  `,
};
