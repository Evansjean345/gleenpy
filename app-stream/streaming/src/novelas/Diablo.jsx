...
const ObjTrailer = {
  videoTrailer:
    "https://www.telemundo.com/sites/nbcutelemundo/files/styles/promotional_content_16_9/public/sites/nbcutelemundo/files/images/tv_show/08_MasSabeDiablo_640x418_2.jpg?itok=G-fE8kSt",
  title: "El diablo",
  text:`Angel Salvador, surnommé "El Diablo" est un des membres éminent du gang "Los Latas" qui sévit dans le Queens à New York`,
  videoModal:"https://www.youtube-nocookie.com/embed/FAz9z6JLa9o"
};

const SecondObj = {
  title: "El diablo",
  text: `Angel Salvador, surnommé "El Diablo" est un des membres éminent du gang "Los Latas" qui sévit dans le Queens à New York. Il vénère sa mère qui ne lui a jamais révélé l'identité de son père, qui les a abandonnés l'un et l'autre il y a 23 ans, et il ferait tout pour elle.
  `,
};
