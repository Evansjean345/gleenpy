...
const ObjTrailer = {
  videoTrailer:
    "https://64.media.tumblr.com/9c66ac7d12ba06d4655c5d92d07f4283/tumblr_inline_oqchvtMkUp1safg2o_250.gifv",
  title: "Catalina",
  text: `La relation entre Catalina (la petite) et Hernán Darío est menacée par l'obsession de Mariana`,
  videoModal:"https://www.youtube-nocookie.com/embed/ZZVUfLjMcBQ",
};

const SecondObj = {
  title: "Catalina",
  text: `La relation entre Catalina (la petite) et Hernán Darío est menacée par l'obsession de Mariana. Elle donnera naissance à une petite fille, nommée Catalina et prétendra que Hernán en est le père. Catalina (la petite) ne la croit pas et fera tout pour trouver l'identité du vrai père…
  `,
};

export default function Catalina() {
