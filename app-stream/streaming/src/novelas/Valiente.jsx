...
const ObjTrailer = {
  videoTrailer:
    "https://3.bp.blogspot.com/-YAPMUaAAmpc/Whsf7IwisaI/AAAAAAAAPbw/C-VCRqVm3eEHGjPc51OuAQRfcxTGaWU4ACLcBGAs/s1600/118c.gif",
  title: "La ley del corazón",
  text: `C'est une histoire qui se déroule dans un cabinet d'avocats prospère spécialisé en droit de la famille, dédié aux cas de séparation et, en général, aux conflits familiaux et de couple.`,
  videoModal:"https://www.youtube-nocookie.com/embed/dblT_Aftc2I",
};

const SecondObj = {
  title: "La ley del corazón",
  text: `C'est une histoire qui se déroule dans un cabinet d'avocats prospère spécialisé en droit de la famille, dédié aux cas de séparation et, en général, aux conflits familiaux et de couple. Plusieurs fois, les décisions que ces avocats sont amenés à prendre les affectent à l'intérieur et à l'extérieur des bureaux et des cours de justice. Certains d'entre eux sont guidés par la loi, mais d'autres, par le cœur. Ce sont deux voies qui ne sont pas toujours compatibles lorsqu'il s'agit de résoudre des conflits juridiques.`,
};
