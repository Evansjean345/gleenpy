...
const ObjTrailer = {
  videoTrailer:
    "https://novelastvclubafrique.files.wordpress.com/2018/07/30c5d-impostora.jpg",
  title: "L'imposture",
  text:`Afin de résoudre le meurtre de Rachel Nickell poignardée puis violée en 1992, une femme officier mène une enquête sous couverture afin de confondre le tueur présumé.`,
  videoModal:"https://www.youtube-nocookie.com/embed/gOBevBFrWfU"
};

const SecondObj = {
  title: "L'imposture",
  text: `Afin de résoudre le meurtre de Rachel Nickell poignardée puis violée en 1992, une femme officier mène une enquête sous couverture afin de confondre le tueur présumé. Sous le nom de "Lizzie James", elle va devenir l'appât sexuel de celui qui va lui faire vivre l'expérience la plus dangereuse de sa carrière.
  `,
};

export default function Imposture() {
