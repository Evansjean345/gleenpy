...
const ObjTrailer = {
  videoTrailer:
    "https://i.pinimg.com/originals/c7/f4/c9/c7f4c95648a04fa469d993b0125f5567.gif",
  title: "Teresa",
  text:`Teresa Chavez est une jeune femme dominée par son avidité. `,
  videoModal:"https://www.youtube-nocookie.com/embed/MNiFKOAHinE"
};

const SecondObj = {
  title: "Teresa",
  text: `Teresa Chavez est une jeune femme dominée par son avidité. Ses parents ont fait de grands sacrifices pour lui donner une bonne éducation, une vie décente, mais Teresa ne se soucie que de devenir riche.`
};
