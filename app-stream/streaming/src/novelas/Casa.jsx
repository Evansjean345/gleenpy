...
const ObjTrailer = {
  videoTrailer:
    "https://i.makeagif.com/media/5-23-2018/TRUfB8.gif",
  title: "La casa de al lado",
  text: ` La famille Conde est une famille riche et influente qui cache de nombreux secrets.`,
  videoModal: "https://www.youtube-nocookie.com/embed/4zLIUXQDXTI",
};

const SecondObj = {
  title: "La casa de al lado",
  text: ` La famille Conde est une famille riche et influente qui cache de nombreux secrets. Après la mort du mari de la fille aînée des Conde qui se nommait "Adolfo", il arrive bien des choses étranges.
  `,
};
