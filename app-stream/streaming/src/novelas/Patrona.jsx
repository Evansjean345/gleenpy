...
const ObjTrailer = {
  videoTrailer:
    "https://c.tenor.com/ger0NbqFFvoAAAAC/teresa-angelique.gif",
  title: "La patrona",
  text: `Gabriela Suárez est violée par Fernando Beltrán alors qu’elle n’est qu’une adolescente, après avoir refusé ses avances.`,
  videoModal:"https://www.youtube-nocookie.com/embed/YnbEpqQyVsk",
};

const SecondObj = {
  title: "La patrona",
  text: `Gabriela Suárez est violée par Fernando Beltrán alors qu’elle n’est qu’une adolescente, après avoir refusé ses avances. Ce dernier n’est autre que le fils cadet d’Antonia Guerra appelée « la Patronne », la femme la plus puissante et la plus crainte de la bourgade de San Pedro del Oro, dirigée par le maire Julio Montemar.
  `,
};

export default function Patrona() {
