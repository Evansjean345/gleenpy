...
const ObjTrailer = {
  videoTrailer:
   "https://crackmagazine.net/wp-content/uploads/2021/11/Pink-Pantheress-Portrait-Gallery-4.jpg",
  title: "PinkPantheress",
  text: "Picture in my mind",
  videoModal:"https://www.youtube-nocookie.com/embed/SIHS1lLzqOo"
};

const SecondObj = {
  title: "Lyrics",
  text: `Always noticed something 'bout you
...
export default function PinkPantheress() {
