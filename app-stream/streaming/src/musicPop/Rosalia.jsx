...
const ObjTrailer = {
  videoTrailer:
    "https://cdn.unitycms.io/images/3oejBY7c4F_ARTS9zSrVSJ.jpg?op=ocroped&val=1600,1600,1000,1000,0,0&sum=DLd2Es3tyLo",
  title: "Rosalià",
  text: "Saoko",
  videoModal:"https://www.youtube-nocookie.com/embed/6o7bCAZSxsg"
};

const SecondObj = {
  title: "Lyrics",
  text: `Chica, ¿qué dices?
  Saoko, papi, saoko
  Saoko, papi, saoko
  Chica, ¿qué dices?
  Saoko, papi, saoko
...
export default function Rosalia() {
