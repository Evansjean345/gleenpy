...
const ObjTrailer = {
  videoTrailer:
   "https://i0.wp.com/www.strong2kinmoov.com/wp-content/uploads/2020/12/img_4372.png?fit=600%2C400&ssl=1",
  title: "Dena Mwana",
  text: "Je Bénirai L'Éternel",
  videoModal:"https://www.youtube-nocookie.com/embed/XR9vBZa9cjo"
};

const SecondObj = {
  title: "Lyrics",
  text: `Alléluia
  Oui, tant que je vivrai je bénirai l'Éternel, alléluia
  Il a fait du bien à mon âme
  Je ne saurai me taire devant ses bien faits
  Je voudrais proclamer qu'il est Dieu
  Il règne éternellement
  Oui mon âme bénit l'Éternel
  Il t'a fait du bien
  Alléluia
  Je bénirai l'Éternel
  Pour tous ses hauts faits
  Sa louange sera
  Toujours dans ma bouche
  Je bénirai l'Éternel, je bénirai
  Je bénirai L'Éternel (pour)
  Pour tout ses hauts faits (oui sa louange)
  Sa louange sera
  Toujours dans ma bouche
  Je bénirai l'Éternel (oh mon âme)
  Oh mon âme bénit l'Éternel (bénit le Dieu d'amour)
  Bénit le Dieu d'amour (oh mon âme)
  Oh mon âme bénit l'Éternel
  Parce qu'il t'a fait du bien
  Oui j'exalterai, j'exalterai l'Éternel`,
};

export default function Dena() {
