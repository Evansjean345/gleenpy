...
const ObjTrailer = {
  videoTrailer:
   "https://www.ceenaija.com/wp-content/uploads/2022/06/Moise-Mbiye-Bilaka-Ya-Bomwana.jpg",
  title: "Moise Mbiye",
  text: "Bilaka ya bo mwana",
  videoModal:"https://www.youtube-nocookie.com/embed/dWzGGgJON30"
};

const SecondObj = {
  title: "Lyrics",
  text: `Bilaka ya bo mwana, yo okokisi yango, sima ya ba mvula nionso oyo
  Otelemisaki moyi, batikali kidiba, na katisi na ngambu
  Bilaka ya bo mwana, yo okokisi yango, sima ya ba mvula nionso oyo
  Otelemisaki moyi, batikali kidiba, opesi nga elonga (oh-oh-oh) hmm
  Lokola yo, na luki na moni te, oh kumama lelo
  Ba mbongé pe mipépé to longi eh, nionso mawa na yo
  Lokola yo, na luki na moni te, oh kumama lelo
  Ba mbongé pe mipépé to longi eh, nionso mawa na yo
  Mawa na yo
  Mokolo ya pasi, yo osali bikamwa, y'obongoli yango ya esengo
  Mokolo ya ko lela, yo osali bikamwa, y'obongoli yango ya esengo
  Mokolo ya kufa, y'osopi mafuta (ey), y'obongoli yango ya bomoyi (Jésus)
  Ebongaki to kabuana, y'osangisi biso, otikeli biso kimia eh
  Lokola yo, na luki na moni te, yako fanda na nga
  Ba mbongé pe mipépé to longi eh, nionso mawa na yo (oh-oh-oh)
  Lokola yo, na luki na moni te, yako fanda na nga eh
  Ba mbongé pe mipépé to longi eh, nionso mawa na yo`,
};

export default function Mbiye() {
