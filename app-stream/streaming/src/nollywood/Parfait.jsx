...
const ObjTrailer = {
  ...
  title: "Imparfaitement parfait",
  text: `Un pauvre coiffeur finit par conquérir le cœur d'une femme très riche`,
  videoModal: "https://www.youtube-nocookie.com/embed/rb5rSXpSbbI",
};
...
export default function Parfait() {
