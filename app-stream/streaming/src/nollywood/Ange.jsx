...
const ObjTrailer = {
  videoTrailer:
    "https://i.ytimg.com/vi/OsrKSCJ4jEM/maxresdefault.jpg",
  title: "Ange de l'amour",
  text: `Zacchary, un ange irresponsable, est condamné par le Grand Conseil à vivre un mois sur terre comme un humain.`,
  videoModal:"https://www.youtube-nocookie.com/embed/OsrKSCJ4jEM",
};

const SecondObj = {
  title: "Ange de l'amour",
  text: `Zacchary, un ange irresponsable, est condamné par le Grand Conseil à vivre un mois sur terre comme un humain. Il fait alors la rencontre de Rebecca, une jeune mère célibataire...
  `,
};
