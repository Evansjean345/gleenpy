...
const ObjTrailer = {
  videoTrailer:
    "https://tel.img.pmdstatic.net/pad/~2~collection~0ae14d36d1c951cb.jpg/900x600/quality/80/le-journal-de-jenifa.jpg",
  title: "Le journal de Jenifa",
  text: `Le Journal de Jenifa  est une série télévisée nigériane créée en 2008 par Funke Akindele, dans laquelle elle tient le rôle principal.`,
  videoModal: "https://www.youtube-nocookie.com/embed/NzIvZ7tJDoo",
};

const SecondObj = {
  title: "Le journal de Jenifa",
  text: `Le Journal de Jenifa (titre original : Jenifa's Diary) est une série télévisée nigériane créée en 2008 par Funke Akindele, dans laquelle elle tient le rôle principal.
  `,
};

export default function Jenifa() {
