...
const ObjTrailer = {
  videoTrailer:
    "https://i.ytimg.com/vi/AZbnnMrbHHg/maxresdefault.jpg",
  title: "La règle",
  text: `Un femme caractèrielle et un mari infidèle se retrouvent embarquès. dans un jeu dont ils ne comprennent pas les règles.`,
  videoModal:"https://www.youtube-nocookie.com/embed/AZbnnMrbHHg",
};
