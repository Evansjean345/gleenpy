...
const ObjTrailer = {
  videoTrailer:
    "https://www.bellanaija.com/wp-content/uploads/2019/07/Osita-Iheme-Aki-Pawpaw.jpg",
  title: "Problème de vente",
  text: `Problème De Vente est un film nigérian de Nollywood où un homme est détesté par beaucoup et craint par tous.`,
  videoModal:"https://www.youtube-nocookie.com/embed/66zTBpkD02E",
};

const SecondObj = {
  title: "Problème de vente",
  text: `Problème De Vente est un film nigérian de Nollywood où un homme est détesté par beaucoup et craint par tous. Partout où il va, son nom fait peur dans le cœur des hommes, la méchanceté est son objectif principal et il ira jusqu'au bout pour y parvenir... Qui résistera à Ajunbe ?
  `,
};
