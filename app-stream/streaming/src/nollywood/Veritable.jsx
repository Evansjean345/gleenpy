...
const ObjTrailer = {
  videoTrailer:
    "https://i.ytimg.com/vi/-eiMgStqWDs/maxresdefault.jpg",
  title: "Coeur du véritable amour",
  text: `Dans ce film nigérian, un jeune médecin a toujours rêvé de ce mariage parfait. Il rencontre enfin l'os de son os et la promène dans l'allée. Mais plus tôt s'était-il marié qu'il était devenu l'expérience du mauvais côté du mariage.`,
  videoModal:"https://www.youtube-nocookie.com/embed/-eiMgStqWDs",
};

const SecondObj = {
  title: "Coeur du véritable amour",
  text: `Dans ce film nigérian, un jeune médecin a toujours rêvé de ce mariage parfait. Il rencontre enfin l'os de son os et la promène dans l'allée. Mais plus tôt s'était-il marié qu'il était devenu l'expérience du mauvais côté du mariage. Les choses sont allées de mal en pis dans son mariage jusqu'à ce qu'il rencontre un couple de personnes âgées dont l'amour durable l'a surpris. Il décide de demander conseil sur la façon dont ils ont pu maintenir leur mariage. Il a suivi les conseils et tente de réparer son mariage. Regardez et appréciez alors qu'il essaie de réparer son propre mariage troublé.
  `,
};

export default function Veritable() {
