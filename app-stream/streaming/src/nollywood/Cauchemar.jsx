...
const ObjTrailer = {
  ...
  text: `Un traitement injuste de la part de son patron pousse Tinuke à faire un effort supplémentaire pour obtenir une promotion à un coût.`,
  videoModal: "https://www.youtube-nocookie.com/embed/gjApsUwu9G8",
};
...
export default function Cauchemar() {
