...
const ObjTrailer = {
  videoTrailer:
    "https://i.guim.co.uk/img/media/10470940704403920dd283f0fea8b27bed013eef/0_119_1428_857/master/1428.jpg?width=1200&height=1200&quality=85&auto=format&fit=crop&s=5f0c7e45c985064ebcb32cba0751799f",
  title: "Davido X Sunday Service Choir",
  text: "Stand Strong",
  videoModal: "https://www.youtube-nocookie.com/embed/KyR6Sd2-afI",
};

const SecondObj = {
  title: "Lyrics",
  text: `Papa told me, "Keep your head up high
  Even though your body full of bite marks from all dem canines"
  (all dem canines, yeah, yeah)
  Steady moving, I'm just living life
  And so many people in my business, so many chookin' eyes
  My fears are easier to face now (face now)
  In the front of my haters
  Steady chasing my paper (ooh)
  Sipping Martel with no chaser (ooh)
  My steps are guided by Jehovah
  And 44 looking over
  Dem no fit stop us, I know that
  And every show is a shutdown (oh)
  `,
};

export default function Davido() {
