...
const ObjTrailer = {
  videoTrailer:
    "https://www.wizkidofficial.com/assets/icons/OGIMAGE.jpg",
  title: "Wizkid X BNXN",
  text: "MOOD",
  videoModal: "https://www.youtube-nocookie.com/embed/r-Q6UrrxF4U",
};

const SecondObj = {
  title: "Lyrics",
  text: `I'm in the big mood
  Girl, I dey feel you
...
export default function Wizkid() {
