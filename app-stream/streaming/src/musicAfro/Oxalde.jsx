...
const ObjTrailer = {
  videoTrailer:
    "https://grungecake.com/wp-content/uploads/2022/07/oxlade-ku-lo-sa-a-colors-show-grungecake-thumbnail.gif",
  title: "Oxalde",
  text: "Ku Lo Sa",
  videoModal:"https://www.youtube-nocookie.com/embed/1pDQjwaH3qk"
};

const SecondObj = {
  title: "Lyrics",
  text: `So many reasons wey I wan dey for you my love
...
export default function Oxalde() {
