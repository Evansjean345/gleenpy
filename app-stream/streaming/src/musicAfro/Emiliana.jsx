...
const ObjTrailer = {
  videoTrailer:
    "https://api.time.com/wp-content/uploads/2022/05/ckay-generation-leaders-2022.jpg",
  title: "Ckay",
  text: "Emiliana",
  videoModal: "https://www.youtube-nocookie.com/embed/Ypr5QN7Xn_M",
};

const SecondObj = {
  title: "Lyrics",
  text: `All because of you, I be on the phone, all night long, oh
...
export default function Emiliana() {
