...
const ObjTrailer = {
  videoTrailer:
    "https://m.media-amazon.com/images/M/MV5BYzJiNzExNzgtNjNhMC00OWZlLTgzZjYtN2JiN2NjMDUyYTgzXkEyXkFqcGdeQXVyMjMyNzY1MjE@._V1_.jpg",
  title: "Laurent et Safi",
  text: "Laurent Balzan, 27 ans, est un jeune cadre d'entreprise d'un milieu aisé. Les deux se rencontrent par internet.",
  videoModal:"https://www.dailymotion.com/embed/video/x5yjag6"
};

const SecondObj = {
  title: "Laurent et Safi",
  text: `Laurent Balzan, 27 ans, est un jeune cadre d'entreprise d'un milieu aisé. Les deux se rencontrent par internet. C'est le coup de foudre. De cette liaison, à priori impossible, naît une merveilleuse histoire d'amour musicale entre la France et l'Afrique.
  `,
};
