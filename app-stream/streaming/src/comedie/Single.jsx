...
const ObjTrailer = {
  videoTrailer:
    "https://i.ytimg.com/vi/Xwj6j2PFeYs/maxresdefault.jpg",
  title: "Zulu Wedding",
  text: `Intitulé “Zulu Wedding“, ce film raconte l'histoire de Lou, une chorégraphe sud-africaine résidant aux États-Unis et qui se retrouve fiancée traditionnellement à un roi sud-africain, suite à une dette ancestrale.`,
  videoModal:"https://www.youtube-nocookie.com/embed/2OJDo2vnMNc"
};

const SecondObj = {
  title: "Zulu Wedding",
  text: `Cette comédie romantique met en scène deux meilleures amies que tout oppose en matière d'hommes, de sexe et d'amour. En dépit de leurs différences, elles traversent ensemble les hauts et les bas du célibat. Tandis que l'une ne peut s'empêcher de chasser un ancien flirt, l'autre tente d'amener son amie à accepter le célibat.
  `,
};
