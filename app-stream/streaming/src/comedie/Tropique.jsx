...
const ObjTrailer = {
  videoTrailer:
    "https://media.tenor.com/xw8gpRYUxIYAAAAC/tropic-thunder.gif",
  title: "Un Anglais sous les tropiques",
  text: "Kinjanja, Afrique Occidentale. Les premières élections démocratiques se préparent.",
  videoModal:"https://www.dailymotion.com/embed/video/x8a3ejw"
};

const SecondObj = {
  title: "Un Anglais sous les tropiques",
  text: `Kinjanja, Afrique Occidentale. Les premières élections démocratiques se préparent. Secrétaire de l'ambassade britannique, Morgan Leafy est un buveur invétéré doublé d'un coureur de jupons insatiable, très à l'aise dans ce monde corrompu. La tension montant à l'approche du scrutin, on lui demande de corrompre l'incorruptible Docteur Murray.
  `,
};

export default function Tropique() {
