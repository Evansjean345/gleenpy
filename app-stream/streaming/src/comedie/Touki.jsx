...
const ObjTrailer = {
  videoTrailer:
    "https://1x77o23r0ru72cdi133cih5f-wpengine.netdna-ssl.com/wp-content/uploads/2018/01/touki-bouki.gif",
  title: "Touki Bouki",
  text: "Touki Bouki raconte l'espoir et les combines d'un jeune couple qui ne rêve que de s'échapper d'un Sénégal post-colonial qui, à leurs yeux, ne respire pas la modernité.",
  videoModal:"https://www.dailymotion.com/embed/video/xv6n50"
};

const SecondObj = {
  title: "Touki Bouki",
  text: `Touki Bouki raconte l'espoir et les combines d'un jeune couple qui ne rêve que de s'échapper d'un Sénégal post-colonial qui, à leurs yeux, ne respire pas la modernité. Pour mener à bien leur projet, ils ont besoin de thunes et vont s'employer à trouver la maille nécessaire par des moyens peu scrupuleux.
  `,
};

export default function Touki() {
