...
const ObjTrailer = {
  videoTrailer:
    "https://www.philippedebroca.fr/wp-content/uploads/2014/04/africain004.jpg",
  title: "L'Africain",
  text: "Victor, amoureux de la nature, a trouvé le repos dans une idyllique contrée de l'Afrique centrale.",
  videoModal:"https://www.dailymotion.com/embed/video/x2pzl11"
};

const SecondObj = {
  title: "L'Africain",
  text: `Victor, amoureux de la nature, a trouvé le repos dans une idyllique contrée de l'Afrique centrale. L'arrivée intempestive de son ex-femme menace son univers paradisiaque. Celle-ci, chargée de dénicher un paradis perdu, veut en effet implanter dans la région un village-vacances pour touristes fortunés.
  `,
};
