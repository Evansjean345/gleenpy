...
const ObjTrailer = {
  videoTrailer:
    "https://s1.dmcdn.net/v/NBis61Vo1z7y2Sh9C/x1080",
  title: "Bienvenue au Gondwana",
  text: "Le Président fondateur du Gondwana se présente à sa propre succession. ",
  videoModal:"https://www.dailymotion.com/embed/video/x6fkeiu" 
};

const SecondObj = {
  title: "Bienvenue au Gondwana",
  text: `Le Président fondateur du Gondwana se présente à sa propre succession. Juriste spécialisé en droit électoral et attaché ministériel, Julien Franchon part en mission dans ce pays d'Afrique. Avec sept autres observateurs, il doit surveiller la légalité du scrutin, sans savoir que la France souhaite maintenir le président actuel au pouvoir.
  `,
};
