...
const ObjTrailer = {
  videoTrailer:
    "https://c.tenor.com/GcOFtE7igQYAAAAC/wak-kandasamys.gif",
  title: "On n'arrête plus les Kandasamys",
  text: "Pour raviver la flamme au sein de leurs couples, deux meilleures amies. ",
  videoModal:"https://www.dailymotion.com/embed/video/x81av2o"
};

const SecondObj = {
  title: "On n'arrête plus les Kandasamys",
  text: `Pour raviver la flamme au sein de leurs couples, deux meilleures amies, Shanthi et Jennifer, organisent une escapade romantique. Or, ce sera sans compter l'aide de leurs maris.
  `,
};

export default function Arrete() {
