...
const ObjTrailer = {
  videoTrailer: "https://images.genius.com/5fb952c30a8d21a659ae48f4534205da.1000x1000x1.jpg",
  title: "Dj Arafat",
  text: "Dosabado",
  videoModal: "https://www.youtube-nocookie.com/embed/XNm6HGlAyTI",
};

const SecondObj = {
  title: "Lyrics",
  text: `Dj Arafat Beruss Sama
  Je vais encore déranger tout le monde
  Prenez position levez les mains Tout le monde
  Tché Dosa! Dosabado sa! Dosabado sa! Dosabado sa!
  Tout le monde dansez Dosabado sa!
  Dosabado sa! DosabadoDODOdOO!
  Dansez Dosabado sa! (Hamed Bakayoko)
  Dosabado sa! Dosabado sa!
  Télékété! dansez Dosabadosa! (Drogba Didier)
  Dosabado sa! Dosabado sa! DosabadoDODO (Diakité le Riche!)
  Tout le monde venez on va faire la fête (faire la fête)
  Tout le monde venez on va s'amuser (va s'amuser)
  Tout le monde venez on va danser (va danser)
  Tout le monde venez on va péter les plombs
  Eh ma cherie, ma cherie! ma cherie! roule ton boule
  Eh ma cherie, ma cherie! ma cherie! fais ton malin`,
};
