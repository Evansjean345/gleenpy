...
const ObjTrailer = {
  videoTrailer:
    "https://media-files.abidjan.net/photo/FEMUA7-2bordo-0033.jpg",
  title: "Debordo Leekunfa",
  text: "Detounounan",
  videoModal: "https://www.youtube-nocookie.com/embed/jJZgw11vRdk",
};
...
export default function Debordo() {
