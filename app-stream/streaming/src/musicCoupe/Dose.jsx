...
const ObjTrailer = {
  videoTrailer: "https://www.ivorian.net/actualites/wp-content/uploads/2022/07/img.13.07.2022f.jpg",
  title: "Serge Beynaud",
  text: "C'est dosé",
  videoModal: "https://www.youtube-nocookie.com/embed/Pw4CqK9ar2Y",
};

const SecondObj = {
  title: "Lyrics",
  text: `Je t'ai vu dire : "Seigneur Dieu !"
  Qui est cette fille? Qui est cette fille?
  Je dis: "Seigneur Dieu!"
  Qui est cette fille? Qui est cette fille?
  Je dis: "Seigneur Dieu!"
  ...
  Oooh, c'est une vraie bête !
  Je pense que je dois attacher mon pantalon
  Il n'est pas comme les autres
  Cette eau de Cologne me tue déjà !
  Et elle porte sa jupe sur ses genoux
  Quand je monte dans ma voiture, je jure que je n'appuierai pas sur les freins
  Le vent emporte tes cheveux
  Je serai celui qui t'escortera chez toi aujourd'hui
  Oo escorte à la maison, oo escorte à la maison
  Ohhh-uu`,
};
