...
const ObjTrailer = {
  videoTrailer: "https://musique.rfi.fr/sites/default/files/thumbnails/image/bebi_philip_c_bstudios.png",
  title: "Bebi philip",
  text: "Le secret",
  videoModal: "https://www.youtube-nocookie.com/embed/_bXjZUg6Duk",
};

const SecondObj = {
  title: "Lyrics",
  text: `Président Agoulou Jhon Killer
  TAB Group à Lomé la référence
  Grand Benjin Kpeglo nous on q secret de ça oh
  C'est le chevalier toujours
  BBP on the track, Siaaaaay
  Leçon numéro 1, je me mêle que de c'qui me regarde
  Leçon numéro 2, le commérages ne m'atteignent pas
  Leçon numéro 3, Je me tiens loin des mauvaise vibes
  C'est ça mon secret d'touts les jours pour garder le smile
  Même quand c'est compliqué, je m'en remets toujours à Dieu
  C'est comme ça que je suis heureux
  C'est pas ma faute
  Moi, je prie, je prie, je prie
