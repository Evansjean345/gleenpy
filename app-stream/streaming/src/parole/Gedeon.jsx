...
const ObjTrailer = {
  videoTrailer: "https://i.ytimg.com/vi/_7ifwncvnNw/maxresdefault.jpg",
  title: "Gedeon de la tchetchouvah",
  text: "",
  videoModal: "https://www.youtube-nocookie.com/embed/-R9wTQ5BReY",
};

const SecondObj = {
  title: "Gedeon de la tchetchouvah :",
  text: " redevons-nous vierges lorsque nous sommes",
};

export default function Gedeon() {
