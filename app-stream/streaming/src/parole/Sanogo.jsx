...
const ObjTrailer = {
  videoTrailer: "https://www.enseignemoi-files.com/site/view/images/dyn-cache/emission/cover/img/25/67/1582810235_256718_1200x667x0.jpg?v=2022022101",
  title: "Mohammed Sanogo",
  text: "",
  videoModal:"https://www.youtube-nocookie.com/embed/Y8_WbXBezIM",
};

const SecondObj = {
  title: "Mohammed Sanogo:",
  text: "Reconnaitre et maximmiser son don",
};

export default function Sanogo() {
          ...
          <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col">
              ...
              <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                <h1 class="sm:w-2/5 text-slate-100 font-bold title-font text-2xl mb-2 sm:mb-0">
                  {SecondObj.title}
                </h1>
                <p class="sm:w-3/5 leading-relaxed text-2xl font-semibold sm:pl-10 pl-0">
                  {SecondObj.text}
                </p>
              </div>
            </div>
