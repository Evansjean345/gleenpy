...
const ObjTrailer = {
  videoTrailer:
    "https://i.pinimg.com/originals/7d/3b/d5/7d3bd575e51ed449557c43c211058379.jpg",
  title: "Luciano X Jesse Royal",
  text: "The music",
  videoModal: "https://www.youtube-nocookie.com/embed/07olcYWw8lo",
};
...
const SecondObj = {
  ...
  text: `Huh
  Wooh yoy
  Small Axe longside Jah MessenjahONENESS!
  Sweet Reggae Music
  HuhNothing they can do to stop
  This yah musicNothing they can do to cramp our style
  (Nothing)
  Say there’s is nothing they
  Can do to stop Jah Jah music
  Nothing they can do to spoil our style
  I say our vibe is from eternity
For years decades and centuries
(Ancient)
Elevating humanity with music of integrity
And though the road has been
So long
(So long dreadlocks)
By God's grace
We carry on
(Jah)
Still with all we been through
Our regrets are few
And together we stand
(Together tog?ther together)
To fight this armag?ddon`,
};

export default function Luciano() {
