...
const ObjTrailer = {
  videoTrailer:
  "https://www.afrik.com/wp-content/uploads/2008/05/alpha-blondy-1200x675.jpg",
  title: "Alpha Blondy",
  text: "Pompier Pyromane",
  videoModal:"https://www.youtube-nocookie.com/embed/cW_awn3pEjE"
};

const SecondObj = {
  title: "Lyrics",
  text: `Pompier pyromane tu ne peux pas tromper le Rastaman
  Pompier pyromane tu ne peux pas tromper le Rastaman
  Pompier pyromane tu n'es qu'un blackheartman I say
  Pompier pyromane tu n'es qu'un blackheartman
  Pompier pyromane tu ne peux pas tromper le Rastaman
  Pompier pyromane tu ne peux pas tromper le Rastaman
  Pompier pyromane tu n'es qu'un blackheartman I say
  Pompier pyromane tu n'es qu'un blackheartman
  Tu vends les armes
  Qui font souffrir nos âmes
  Tu attises les flammes que tu éteinds avec nos larmes
  Le maître de l'univers brisera ton cœur de pierre
  Il entend nos pleurs, il entend nos prières
  Pompier pyromane tu ne peux pas tromper le Rastaman
  Pompier pyromane tu ne peux pas tromper le Rastaman
  Pompier pyromane tu n'es qu'un blackheartman I say
  Pompier pyromane tu n'es qu'un blackheartman
...
export default function Blondy() {
