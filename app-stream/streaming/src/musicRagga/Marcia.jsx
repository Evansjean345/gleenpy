...
const ObjTrailer = {
  videoTrailer:
  "https://www.reggaereflection.com/wp-content/uploads/2019/11/Marcia-Griffiths-TheHoward-FedGaray-ReggaeReflection-06821.jpg",
  title: "Marcia Griffiths",
  text: "Holding You Close",
  videoModal:"https://www.youtube-nocookie.com/embed/82hFfYvTADU",
};

const SecondObj = {
  title: "Lyrics",
  text: `Let nothing spoil the vibe
  This is our place
  ...
  So tell me would you mind if we
  Dance a little more right here
  And even if it's five minutes longer
  That I have you here
  And baby I, I can't stand the feeling
  Without you 'round me
  So take this time for love,
  For us, for me and you now`,
};

export default function Marcia() {
