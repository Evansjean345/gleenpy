...
const ObjTrailer = {
  videoTrailer:
    "https://i.gifer.com/5y41.gif",
  title: "Le prince d'egypte",
  text: "Découvrez l'histoire extraordinaire de Ramsès II, né de sang royal, et Moïse, un orphelin au passé secret.",
  videoModal: "https://www.dailymotion.com/embed/video/x3r85pn" ,
};

const SecondObj = {
  title: "Le prince d'egypte",
  text: `Découvrez l'histoire extraordinaire de Ramsès II, né de sang royal, et Moïse, un orphelin au passé secret. Élevés comme deux frères, ils partagent une jeunesse dorée, pleine de fougue et de défis. Mais le destin va les séparer brutalement. L'un deviendra pharaon et régnera sur l'Égypte, l'empire le plus puissant du monde, et l'autre sera l'élu chargé de libérer son peuple. Leur confrontation changera à jamais leur vie et l'histoire de l'humanité...
  `,
};
