...
const ObjTrailer = {
  videoTrailer:
    "https://www.oaqadi.fr/sites/default/files/11041680_1131480273534876_6413375098125183260_o_1.jpg",
  title: "Adama",
  text: "Adama, 12 ans, vit dans un village isolé d'Afrique de l'Ouest. Au-delà des falaises, s'étend le Monde des Souffles. ",
  videoModal: "https://www.dailymotion.com/embed/video/x33a1ra"
};

const SecondObj = {
  title: "Adama",
  text: `Adama, 12 ans, vit dans un village isolé d'Afrique de l'Ouest. Au-delà des falaises, s'étend le Monde des Souffles. Là où règnent les Nassaras. Une nuit, Samba, son frère aîné, disparaît. Adama, bravant l'interdit des anciens, décide de partir à sa recherche.
  `,
};
