...
const ObjTrailer = {
  videoTrailer:
    "https://media0.giphy.com/media/MSRLPAkKlbFkzTD7Tb/giphy.gif?cid=6c09b9527d570ef77b318dc00eaacbcb2d4b653d7f238bb3&rid=giphy.gif&ct=g",
  title: "kirikou",
  text: "`Kirikou est un petit garçon très volontaire, d'ailleurs tout le monde dit : Kirikou n'est pas grand, mais il est vaillant'.",
  videoModal: "https://www.dailymotion.com/embed/video/x3ci6l9" ,
};

const SecondObj = {
  title: "kirikou",
  text: `Kirikou est un petit garçon très volontaire, d'ailleurs tout le monde dit : Kirikou n'est pas grand, mais il est vaillant'. Dans son village, en Afrique, la sorcière Karaba a jeté un sort : la source est asséchée, les villageois rançonnés et les hommes enlevés. Kirikou veut découvrir le secret de la méchanceté de Karaba afin de délivrer le village de son emprise.
  `,
};

export default function Kirikou() {
