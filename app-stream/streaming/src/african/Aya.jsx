...
const ObjTrailer = {
  videoTrailer:
    "https://64.media.tumblr.com/a0df950a127f2841930875ed902ff7bf/tumblr_mobk0liFDD1s5qs0yo1_400.gif",
  title: "Aya de yopougon",
  text: "En cette fin des années 1970, Aya, 19 ans, habite avec sa famille à Yopougon, un quartier populaire d'Abidjan.",
  videoModal: "https://www.dailymotion.com/embed/video/x3svmlg" ,
};

const SecondObj = {
  title: "Aya de yopougon",
  text: `En cette fin des années 1970, Aya, 19 ans, habite avec sa famille à Yopougon, un quartier populaire d'Abidjan. C'est une jeune fille sérieuse qui souhaite se concentrer sur ses études et sa future carrière de médecin. Ses copines Adjoua et Bintou pensent, elles, plutôt aux garçons et aux sorties en douce sous les étoiles. Aya classe ses amies dans la série C, soit coiffure, couture, commerce et chasse au mari, série qu'elle veut éviter à tout prix.
  `,
};
