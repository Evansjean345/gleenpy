...
const ObjTrailer = {
  videoTrailer:
    "https://64.media.tumblr.com/f7b0493d386fbdbd61d7b1c2bbdc2157/tumblr_nqrwr6Aqu41skj0ayo1_500.gifv",
  title: "Zarafa",
  text: "L'histoire se déroule dans les années 1820. Maki est un jeune esclave noir âgé de 10 ans qui vit au Soudan.",
  videoModal: "https://www.dailymotion.com/embed/video/xodzuj" ,
};

const SecondObj = {
  title: "Zarafa",
  text: `L'histoire se déroule dans les années 1820. Maki est un jeune esclave noir âgé de 10 ans qui vit au Soudan. Une nuit, il parvient à échapper de l'esclavagiste français qui le retenait prisonnier, mais il doit abandonner son amie Soula. Au cours de sa fuite, Maki rencontre une jeune girafe et sa mère. Lorsque l'esclavagiste le rattrape et le menace de son fusil, la mère girafe s'interpose et le sauve, mais l'homme la tue.
  `,
};

export default function Zarafa() {
