...
const ObjTrailer = {
  videoTrailer:
    "http://www.out.tn/uploads/media/default/0001/04/thumb_3995_default_big.jpeg",
  title: "Pokou",
  text: "Au 18e siècle, dans le royaume du peuple Ashanti, qui couvre les deux tiers de l'actuel Ghana, vit la princesse Abla Pokou.",
  videoModal: "https://www.dailymotion.com/embed/video/x8ead4s"
};

const SecondObj = {
  title: "Pokou",
  text: `Au 18e siècle, dans le royaume du peuple Ashanti, qui couvre les deux tiers de l'actuel Ghana, vit la princesse Abla Pokou. Conseillère très influente auprès du roi Opokou Warê, elle est opposée à la guerre. Pokou est un sérieux obstacle sur le chemin de l'ancien guerrier Kongouê Bian devenu adepte de sorcellerie. Assoiffé de pouvoir, il tente un coup d'Etat contre le roi, son meilleur ami et se débarrasse de l'héritier légitime du trône.
  `,
};

export default function Pokou() {
