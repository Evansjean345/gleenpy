...
const ObjTrailer = {
  videoTrailer:
    "https://i.pinimg.com/originals/29/1d/03/291d0392aea9b01a08bb6a1333d6f2ea.gif",
  title: "Le roi Lion",
  text: "Un lionceau nommé Simba est exilé de son royaume après avoir été accusé d'être responsable de la mort de son père, Mufasa. ",
  videoModal: "https://www.dailymotion.com/embed/video/x7mkj2k" ,
};

const SecondObj = {
  title: "Le roi Lion",
  text: `Un lionceau nommé Simba est exilé de son royaume après avoir été accusé d'être responsable de la mort de son père, Mufasa. Avec l'aide d'un étrange duo composé d'un suricate et d'un phacochère, il décide de reprendre ce qui lui revient de droit lorsqu'il apprend qu'il est destiné à être roi.
  `,
};
