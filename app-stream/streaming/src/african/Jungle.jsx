...
const ObjTrailer = {
  videoTrailer:
    "https://fr.web.img6.acsta.net/r_1280_720/pictures/21/04/21/19/51/1741390.jpg",
  title: "Jungle",
  text: "Le film reprend les personnages de la série d'animation Jungle Beat (en).",
  videoModal: "https://www.dailymotion.com/embed/video/x8a2ltr"
};

const SecondObj = {
  title: "Jungle",
  text: `Le Rythme de la jungle (Jungle Beat: The Movie) est un film d'animation mauricien et sud-africain réalisé par Brent Dawes et sorti en 2020.
  `,
};
