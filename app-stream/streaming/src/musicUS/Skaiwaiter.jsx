...
const ObjTrailer = {
  videoTrailer:
    "https://i1.sndcdn.com/artworks-fHW21N9dKvZ4Kfpg-Rou3FQ-t500x500.jpg",
  title: "Skaiwaiter",
  text: "#Miles",
  videoModal:"https://www.youtube-nocookie.com/embed/_WgKrKKkZgA"
};

const SecondObj = {
  title: "Lyrics",
  text: `Then we could talk it out, maybe
...
export default function Skaiwater() {
