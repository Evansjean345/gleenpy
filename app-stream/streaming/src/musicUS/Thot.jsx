...
const ObjTrailer = {
  ...
  title: "Megan Thee Stalion",
  text: "Thot Shit",
  videoModal: "https://www.youtube-nocookie.com/embed/KynkMn5Hv3Q",
};

const SecondObj = {
  title: "Lyrics",
  text: `Hands on my knees, shakin' ass, on my thot shit
