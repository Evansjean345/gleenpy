...
const ObjTrailer = {
  videoTrailer:
    "https://media.distractify.com/brand-img/kW-cEm1pd/0x0/ice-spice-1663884912294.jpg",
  title: "Ice Spice",
  text: "Munch(Feelin'U)",
  videoModal: "https://www.youtube-nocookie.com/embed/yF-NC3eRsqc",
};

const SecondObj = {
  title: "Lyrics",
  text: `You thought I was feelin you? (nah)
  That nigga a munch
  ...
  Bitches ain't bad lets keep it a bean
  Know they be mad I be on the scene
  Ass too fat cant fit in a jean
  You was my stitch but its not what it seam
  I got that wetty I'm keepin' it clean
  Fuckin' with niggas thats totin' a beam
  Sayin' you love me but what do you mean
  Pretty as fuck and he like that im mean
  Baddest bitch out you shittin' me? (shittin' me)
  If you ain't a baddie cant sit with me (sit with me)`,
};
