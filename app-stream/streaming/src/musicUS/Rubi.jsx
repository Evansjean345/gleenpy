...
const ObjTrailer = {
  videoTrailer:
    "https://www.mefeater.com/wp-content/uploads/2021/08/Rubi-Rose-M-scaled-e1629385685670.jpg",
  title: "Rubi Rose",
  text: "Wifey",
  videoModal: "https://www.youtube-nocookie.com/embed/75aM1mqCZQQ" ,
};
...
const SecondObj = {
  ...
  (Ha, ha, ha)
  (On the gang)
  My shit Cartier with baguettes, that's a bet (bet)
  ...
  "Rubi a ho, " that's cap, bitch, I'm wifey
  ...
  Jacques Marie on my face, it's like run to that (ayy)
  Whole squad in this bitch, I'm the running back (yeah)`
};

export default function RubiRose() {
