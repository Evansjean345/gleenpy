...
const ObjTrailer = {
  videoTrailer:
    "https://c.tenor.com/XOL5DDIv3vgAAAAC/scorpion-mk-movie.gif",
  title: "Mortal Kombat",
  text: ` Dans "Mortal Kombat", le combattant de MMA Cole Young, habitué à prendre des coups pour de l'argent, ignore son histoire .`,
  videoModal:"https://www.dailymotion.com/embed/video/x7zebln",
};

const SecondObj = {
  title: "Mortal Kombat",
  text: ` Dans "Mortal Kombat", le combattant de MMA Cole Young, habitué à prendre des coups pour de l'argent, ignore son histoire - ou pourquoi l'empereur Shang Tsung d'Outworld a envoyé son meilleur guerrier, Sub-Zero, un Cryomancien d'un autre monde, pour traquer Cole.",
  `,
};

export default function Kombat() {
