...
const ObjTrailer = {
  videoTrailer:
    "https://media.tenor.com/oSvnre4Twt4AAAAC/dodge-nathan-drake.gif",
  title: "Uncharted",
  text: `Le chasseur de trésors Victor Sully Sullivan recrute Nathan Drake pour l'aider à récupérer une fortune vieille de 500 ans amassée par l'explorateur Ferdinand Magellan.`,
  videoModal:"https://www.dailymotion.com/embed/video/x8dvwyb",
};

const SecondObj = {
  title: "Uncharted",
  text: `Le chasseur de trésors Victor Sully Sullivan recrute Nathan Drake pour l'aider à récupérer une fortune vieille de 500 ans amassée par l'explorateur Ferdinand Magellan. Ce qui commence comme un cambriolage devient rapidement une course de globe-trotters pour atteindre le prix avant que l'impitoyable Santiago Moncada ne puisse mettre la main dessus.",
  `,
};
