...
const ObjTrailer = {
  videoTrailer:
    "https://4.bp.blogspot.com/-E-v4Q1mzpA0/WjA0xBOPzmI/AAAAAAAAQhE/eDrLXmzLo6gF3J1SRQ9aLPD5wPdcX_ZaQCLcBGAs/s1600/BrightTrailer3.gif",
  title: "Bright",
  text: `Dans un monde contemporain alternatif, humains, orcs, elfes et fées coexistent depuis le début des temps.`,
  videoModal:"https://www.dailymotion.com/embed/video/x6cn19f",
};

const SecondObj = {
  title: "Bright",
  text: `Dans un monde contemporain alternatif, humains, orcs, elfes et fées coexistent depuis le début des temps. Confrontés aux ténèbres lors d'une patrouille nocturne de routine à Los Angeles, ils tombent sur un objet puissant et ils voient leur avenir et leur monde se métamorphoser à jamais.",
  `,
};
