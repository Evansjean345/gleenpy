...
const ObjTrailer = {
  videoTrailer:
    "https://i.gifer.com/PAMZ.gif",
  title: "Misfits",
  text: `Nathan Young, Simon Bellamy, Kelly Bailey, Curtis Donovan et Alisha Daniels sont cinq jeunes adultes ayant été condamnés, pour des raisons diverses .`,
  videoModal:"https://www.dailymotion.com/embed/video/xjpe9g",
};

const SecondObj = {
  title: "Misfits",
  text: `Nathan Young, Simon Bellamy, Kelly Bailey, Curtis Donovan et Alisha Daniels sont cinq jeunes adultes ayant été condamnés, pour des raisons diverses, à des travaux d'intérêt général (TIG). Alors qu'ils effectuent leur premier jour, non sans provoquer Tony Morecombe, leur superviseur, un violent orage éclate.",
  `,
};

export default function Misfits() {
