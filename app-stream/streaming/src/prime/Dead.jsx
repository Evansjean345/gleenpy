...
const ObjTrailer = {
  videoTrailer:
    "https://i.gifer.com/FsY7.gif",
  title: "Deadpool",
  text: `Wade Wilson, un ancien militaire des forces spéciales, est devenu mercenaire. Après avoir subi une expérimentation hors-norme qui va accélérer ses pouvoirs de guérison, il va devenir Deadpool.`,
  videoModal:"https://www.dailymotion.com/embed/video/x34hrwj",
};

const SecondObj = {
  title: "Deadpool",
  text: `Wade Wilson, un ancien militaire des forces spéciales, est devenu mercenaire. Après avoir subi une expérimentation hors-norme qui va accélérer ses pouvoirs de guérison, il va devenir Deadpool. Armé de ses nouvelles capacités et d'un humour noir survolté, il va traquer l'homme qui a bien failli anéantir sa vie.",
  `,
};
