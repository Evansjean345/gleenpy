...
const ObjTrailer = {
  videoTrailer:
    "https://thumbs.gfycat.com/AlarmedPresentCapybara-size_restricted.gif",
  title: "HellBoy",
  text: `Hellboy est de retour, et il est en feu. Le légendaire superhéros mi-homme mi-démon devra combattre un trio de géants déchainés dans les plaines de l'Angleterre.`,
  videoModal:"https://www.dailymotion.com/embed/video/x73oi9l",
};

const SecondObj = {
  title: "HellBoy",
  text: `Hellboy est de retour, et il est en feu. Le légendaire superhéros mi-homme mi-démon devra combattre un trio de géants déchainés dans les plaines de l'Angleterre. C'est là qu'il y découvrira la Reine de Sang, Nimue, une ancienne sorcière ressuscitée en quête de vengeance. Pris entre les griffes du surnaturel et du monde humain, Hellboy devra arrêter Nimue tout en évitant la fin du monde.",
  `,
};

export default function Hellboy() {
