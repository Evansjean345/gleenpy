...
const ObjTrailer = {
  videoTrailer:
    "https://siobhanaisling.files.wordpress.com/2019/02/giphy-1.gif",
  title: "BlacKkKlansman : J'ai infiltré le Ku Klux Klan",
  text: `Au début des années 1970, plusieurs émeutes raciales éclatent dans les grandes villes des États-Unis.`,
  videoModal:"https://www.dailymotion.com/embed/video/x88uhne",
};

const SecondObj = {
  title: "BlacKkKlansman : J'ai infiltré le Ku Klux Klan",
  text: `Au début des années 1970, plusieurs émeutes raciales éclatent dans les grandes villes des États-Unis. Ron Stallworth devient le premier officier noir américain du Colorado Springs Police Department, mais son arrivée est accueillie avec scepticisme, voire avec une franche hostilité. Prenant son courage à deux mains, Stallworth va tenter de faire bouger les lignes. Il se fixe alors une mission des plus périlleuses : infiltrer le Ku Klux Klan pour en dénoncer les exactions.",
  `,
};
