...
const ObjTrailer = {
  videoTrailer:
    "https://i.gifer.com/hfm.gif",
  title: "Game of Thrones",
  text: `Après un été de dix années, un hiver rigoureux s'abat sur le Royaume avec la promesse d'un avenir des plus sombres.`,
  videoModal:"https://www.dailymotion.com/embed/video/x75ilbr",
};

const SecondObj = {
  title: "Game of Thrones",
  text: `Après un été de dix années, un hiver rigoureux s'abat sur le Royaume avec la promesse d'un avenir des plus sombres. Pendant ce temps, complots et rivalités se jouent sur le continent pour s'emparer du Trône de Fer, le symbole du pouvoir absolu.",
  `,
};
