...
const ObjTrailer = {
  videoTrailer:
    "https://i.gifer.com/Hxwb.gif",
  title: "Prison Break",
  text: `Un jeune ingénieur, Michael Scofield, se fait emprisonner volontairement au pénitencier de Foxriver. Son objectif : aider son frère, Lincoln Burrows, condamné à mort suite à un meurtre`,
  videoModal: "https://www.dailymotion.com/embed/video/x53uapz",
};

const SecondObj = {
  title: "Prison Break",
  text: `Un jeune ingénieur, Michael Scofield, se fait emprisonner volontairement au pénitencier de Foxriver. Son objectif : aider son frère, Lincoln Burrows, condamné à mort suite à un meurtre qu'il n'a pas commis, à s'évader de prison. Pour cela, Scofield s'est fait tatouer sur le corps les plans du pénitencier.",
  `,
};
