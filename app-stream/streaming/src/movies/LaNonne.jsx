...
const ObjTrailer = {
  videoTrailer: "https://img.filmsactu.net/datas/films/l/a/la-nonne/n/la-nonne-gif-5ba26c2a7b4be.gif",
  title: "La Nonne",
  text: `Lorsqu'une jeune nonne se suicide dans une abbaye roumaine, la stupéfaction est totale dans l'Église catholique. Le Vatican missionne aussitôt un prêtre au passé trouble et une novice pour mener l'enquête.`,
  videoModal: "https://www.dailymotion.com/embed/video/x8a1npi",
};

export default function LaNonne() {
            ...
            <div class="flex flex-col">
              ...
              <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                ...
                <p class="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">
                  Par une sombre nuit de l'année 1952, deux religieuses
                  terrifiées se rendent dans les catacombes de leur abbaye de
                  Saint-Carta, en Roumanie. Après avoir ouvert une sinistre
                  porte sur laquelle sont gravés les mots "Finit hic deo" (Dieu
                  s'arrête ici), l'une des religieuses disparaît dans
                  l'obscurité, tandis que l'autre, après s'être enfuie, finit
                  par se pendre en se jetant par une fenêtre de l'abbaye.
                </p>
              </div>
            </div>
