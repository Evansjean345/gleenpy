...
const ObjTrailer = {
  videoTrailer:
    "https://64.media.tumblr.com/c0e783a32ffe36833d9791bb1cc76ba4/7e8dce0ac6608aec-75/s500x750/72de8118ab87cdf6ed97539f55e450229c40e232.gifv",
  title: "Mon ami Adèle - Behind Her Eyes",
  text: "Une mère célibataire commence une liaison adultérine avec un homme marié. La jeune femme se noue d'amitié avec l'épouse bafouée.",
  videoModal: "https://www.dailymotion.com/embed/video/x7ziial",
};

export default function BehindHerEyes() {
            ...
            <div class="flex flex-col">
              ...
              <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                ...
                <p class="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">
                  Louise est une jeune femme divorcée et mère d'un petit garçon,
                  Adam. Un soir alors qu'une amie lui fait faux bond à un bar,
                  elle rencontre un homme séduisant. À la sortie du bar, ils
                  s'embrassent, mais l'homme s'excuse avant de partir
                  précipitamment. Le lendemain, à son travail de secrétaire dans
                  un cabinet de psychiatres, Louise découvre le nouveau
                  psychiatre et sa femme. Le docteur David Ferguson est en fait
                  l'inconnu de la veille. Lorsque Louise le voit seul, elle lui
                  dit que rien ne s'est passé. Peu de temps après, elle croise
                  sa femme Adele dans la rue. Elles sympathisent et deviennent
                  peu à peu amies. Mais le couple semble partager un sombre
                  secret.
                </p>
              </div>
            </div>
