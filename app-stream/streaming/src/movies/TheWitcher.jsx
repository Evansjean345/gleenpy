...
const ObjTrailer = {
  videoTrailer:
    "https://thumbs.gfycat.com/JitteryInfatuatedHuia-size_restricted.gif",
  title: "The Witcher",
  text: "Après avoir survécu à la Chasse Sauvage et sauvé le monde d'un hiver éternel, Geralt de Riv poursuit la formation de sa protégée, Ciri, au rude métier de Sorceleur.",
  videoModal: "https://www.dailymotion.com/embed/video/x8a1rll",
};
    ...
    <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
      <div class="rounded-lg h-64 overflow-hidden">
        <iframe
          ...
          src="https://www.dailymotion.com/embed/video/x8a1ghb"
  ...
  <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
    <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
      <div class="rounded-lg h-64 overflow-hidden">
        <iframe
          class="rounded-lg h-64 w-full overflow-hidden"
          src="https://www.dailymotion.com/embed/video/x858pu8"
          title="too hot to handle"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture ;"
          allowfullscreen="true"
            ...
            <div class="flex flex-col">
              ...
              <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                ...
                <p class="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">
                  Il met en vedette Henry Cavill, Anya Chalotra et Freya Allan.
                  La première saison est basée sur Le Dernier Vœu et L'Épée de
                  la providence, une collection d'histoires courtes qui
                  précèdent la saga principale de Witcher. La première saison
                  est un ensemble de nouvelles qui ont façonné les trois
                  personnages principaux, avant leurs premières rencontres les
                  uns avec les autres et qui se déroule donc avant la vraie
                  saison, la deuxième.
                </p>
              </div>
            </div>
