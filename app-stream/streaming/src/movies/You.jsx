...
const ObjTrailer = {
  videoTrailer: "https://media4.giphy.com/media/ZFp7ng2k5l2E8edhc8/giphy.gif",
  title: "  You",
  text: "Joe Goldberg est un brillant jeune homme qui tient une librairie à New York. Un jour, il tombe amoureux d'une de ses clientes, Guinevere. La jeune femme, qui aspire à devenir écrivain, l'obsède complètement.",
  videoModal: "https://www.dailymotion.com/embed/video/x8a2luo",
};
    ...
    <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
      <div class="rounded-lg h-64 overflow-hidden">
        <iframe
          ...
          src="https://www.dailymotion.com/embed/video/x8a2luo"
          title="you"
          frameborder="0"
  ...
  <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
    <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
      <div class="rounded-lg h-64 overflow-hidden">
        <iframe
          class="rounded-lg h-64 w-full overflow-hidden"
          src="https://www.dailymotion.com/embed/video/x7pa9a6"
          title="you"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture ;"
          allowfullscreen="true"
  ...
  <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
    <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
      <div class="rounded-lg h-64 overflow-hidden">
        <iframe
          class="rounded-lg h-64 w-full overflow-hidden"
          src="https://www.dailymotion.com/embed/video/x84amzb"
          title="you"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture ;"
          allowfullscreen="true"
            ...
            <div class="flex flex-col">
              ...
              <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                ...
                <p class="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">
                  Joe, le gérant d'une librairie new-yorkaise, devient obsédé
                  par Beck, une jeune aspirante écrivaine qui partage sa passion
                  pour les livres et pour la poésie.
                </p>
              </div>
            </div>
