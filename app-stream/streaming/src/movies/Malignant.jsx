...
const ObjTrailer = {
  videoTrailer: "https://c.tenor.com/nGPsyGO0qXEAAAAC/malignant-chair.gif",
  title: "Malignant",
  text: `Madison a connu une enfance traumatisante jusqu'à ce qu'elle soit prise sous les ailes d'une charmante famille d'accueil. Maintenant adulte, son passé troublant la rattrape sous forme de cauchemars .`,
  videoModal: "https://www.dailymotion.com/embed/video/x82umga"
};

const SecondObj = {
  title: "Malignant",
  text: "En juillet 2019, James Wan est annoncé comme réalisateur d'un film produit par New Line Cinema, écrit par Akela Cooper et J. T. Petty et basé sur une idée de l'actrice Ingrid Bișu. Cette dernière participe également à la production du film notamment avec Michael Clear et la société Atomic Monster Productions de James Wan.",
};

export default function Malignant() {
