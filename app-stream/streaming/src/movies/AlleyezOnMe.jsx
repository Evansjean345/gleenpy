...
const ObjTrailer = {
  videoTrailer: "https://i.gifer.com/HbO5.gif",
  title: "All eyez one me",
  text: "En 1995, alors que le rappeur Tupac Shakur purge sa peine dans la prison de Dannemora, un réalisateur et son équipe viennentl'interviewer.. ",
  videoModal : "https://www.dailymotion.com/embed/video/x5xrebn"
};

export default function AlleyezOnMe() {
            ...
            <div class="flex flex-col">
              ...
              <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                ...
                <p class="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">
                  L'histoire unique de Tupac Shakur, le légendaire rappeur,
                  poète, acteur et révolutionnaire ayant vendu plus de 80
                  millions d'albums à travers le monde, faisant de lui un des
                  artistes les plus populaires de tous les temps. Fils d'un père
                  activiste des Black Panthers, élevé dans un monde d'injustice,
                  les épreuves de Tupac ont forgé sa voix.
                </p>
              </div>
            </div>
