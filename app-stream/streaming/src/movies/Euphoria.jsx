...
const ObjTrailer = {
  videoTrailer: "https://media1.giphy.com/media/FBWz9ZQtQYTRqRC7S6/giphy.gif",
  title: "Euphoria",
  text: "Produite par Drake, Euphoria explore le quotidien d'un groupe de lycéens américains qui noient leurs problèmes dans le sexe, l'alcool et la drogue.",
  videoModal: "https://www.dailymotion.com/embed/video/x885sti",
};
    ...
    <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
      <div class="rounded-lg h-64 overflow-hidden">
        <iframe
          ...
          src="https://www.dailymotion.com/embed/video/x7b1irb"
          title="you"
          frameborder="0"
  ...
  <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
    <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
      <div class="rounded-lg h-64 overflow-hidden">
        <iframe
          class="rounded-lg h-64 w-full overflow-hidden"
          src="https://www.dailymotion.com/embed/video/x885sti"
          title="you"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture ;"
          allowfullscreen="true"
            ...
            <div class="flex flex-col">
              ...
              <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                ...
                <p class="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">
                  Mettant en scène des lycéens de la Génération Z, Euphoria
                  explore les différentes expériences que traversent ces
                  adolescents et aborde de nombreuses thématiques, par exemple :
                  la recherche de soi, les traumatismes, les relations amicales
                  et amoureuses ou encore l'addiction.
                </p>
              </div>
            </div>
