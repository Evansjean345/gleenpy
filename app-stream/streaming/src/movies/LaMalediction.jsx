...
const ObjTrailer = {
  videoTrailer: "https://static1.purebreak.com/articles/2/17/45/32/@/669625-la-malediction-de-la-dame-blanche-actuel-624x0-1.gif",
  title: "La malediction de la dame blanche",
  text: `Quand elle était en vie, elle a noyé ses enfants dans un accès de folle jalousie, puis, dévastée par le chagrin, elle s'est jetée dans le fleuve.`,
  videoModal: "https://www.dailymotion.com/embed/video/x8a2dx0",
};

export default function LaMalediction() {
            ...
            <div class="flex flex-col">
              ...
              <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                ...
                <p class="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">
                  Trois cents ans plus tard, en 1973, à Los Angeles, Anna est
                  assistante sociale du service de protection des enfants. Son
                  mari, policier, a été tué au cours d'une intervention de
                  service un an auparavant ; elle reste seule à élever ses deux
                  enfants. Elle se rend au domicile de Patricia, une femme
                  soupçonnée de maltraiter ses enfants. Elle y découvre les deux
                  enfants dans un placard, enfermés à double tour. Patricia est
                  placée en garde à vue et les enfants placés en foyer
                  d'accueil. La nuit suivante, un spectre blanchâtre poursuit
                  les enfants. Ceux-ci sont retrouvés noyés dans le fleuve.
                </p>
              </div>
            </div>
