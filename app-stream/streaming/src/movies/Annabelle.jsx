...
const ObjTrailer = {
  videoTrailer: "https://c.tenor.com/kh3QWtXyoh4AAAAd/anabelle-thriller.gif",
  title: "Annabelle",
  text: `Été 1969, John et Mia, qui attendent leur premier enfant, viennent d'emménager dans une maison à Santa Monica. John, qui ne sait comment choyer son épouse, lui a offert une poupée ancienne.`,
  videoModal: "https://www.dailymotion.com/embed/video/x25hszu",
};

const SecondObj = {
  title: "Annabelle",
  text: "En 1970, à Santa Monica, le médecin John Form offre à sa femme enceinte Mia, une rare poupée de porcelaine vintage en cadeau pour leur premier enfant. Mia la place dans sa collection de poupées dans la chambre de leur futur enfant.",
};
