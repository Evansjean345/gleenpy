...
const ObjTrailer = {
  videoTrailer:
    "https://i.skyrock.net/9596/91579596/pics/3268305228_1_8_soHLXEVR.gif",
  title: "The Silence",
  text: `De terrifiantes créatures ont envahi la Terre, chassant leurs proies humaines au bruit. Pour leur échapper, les Andrews se réfugient dans un lieu isolé .`,
  videoModal: "https://www.dailymotion.com/embed/video/x8a380n",
};
            ...
            <div class="flex flex-col">
              ...
              <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                ...
                <p class="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">
                  Une équipe de recherche dans les grottes déterre une espèce
                  inconnue de créature ressemblant à un ptérosaure , appelée
                  "vesps", dans une mine. Les vesps tuent violemment les
                  chercheurs, s'envolent hors de la mine et recherchent les
                  zones les plus bruyantes. Ally Andrews, une adolescente qui a
                  perdu l'audition dans un accident de voiture, vit avec ses
                  parents Hugh et Kelly Andrews ; sa grand-mère maternelle Lynn,
                  atteinte d' un cancer du poumon en phase terminale ; son frère
                  Jude; et un chien de compagnie.
                </p>
              </div>
            </div>
