...
const ObjTrailer = {
  videoTrailer:
    "https://i0.wp.com/explicationdefilm.com/wp-content/uploads/2020/03/platform.gif?fit=500%2C208&ssl=1",
  title: "La PLateforme",
  text: `Dans le futur, des prisonniers sont détenus dans des cellules verticales. Ceux qui logent dans les cellules supérieures sont nourris, tandis que ceux des cellules inférieures meurent de faim.`,
  videoModal:"https://www.dailymotion.com/embed/video/x7xom4f",
};

const SecondObj = {
  title: "La PLateforme",
  text: `Dans le futur, des prisonniers sont détenus dans des cellules verticales. Ceux qui logent dans les cellules supérieures sont nourris, tandis que ceux des cellules inférieures meurent de faim. Goreng, un détenu fraîchement débarqué, va se battre pour changer le système.
  `,
};
