...
const ObjTrailer = {
  videoTrailer:
    "https://64.media.tumblr.com/be218c93d47cbf0e5dbcc59de47fca14/tumblr_inline_pg8u6illTQ1qm4wze_500.gifv",
  title: "Truth or Dare",
  text: `Un simple jeu innocent d'Action ou Vérité entre amis se transforme en cauchemar sanglant quand quelqu'un – ou quelque chose – commence à punir ceux qui mentent – ou refusent de jouer.`,
  videoModal: "https://www.dailymotion.com/embed/video/x6fxai6",
};
            ...
            <div class="flex flex-col">
              ...
              <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                ...
                <p class="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">
                  Un groupe d'amis voyagent au Mexique pour une escapade avant
                  l'obtention de leur diplôme. Là bas, un étranger convainc l'un
                  d'eux de jouer à un jeu de vérité ou conséquence apparemment
                  inoffensif. Une fois que le jeu commence, quelque chose de
                  maléfique s'éveille -- un démon qui force les amis à partager
                  de sombres secrets et à confronter leurs peurs les plus
                  profondes. Les règles sont simples, mais méchantes - dire la
                  vérité ou mourir, oser ou mourir, et si vous arrêtez de jouer,
                  vous mourrez.
                </p>
              </div>
            </div>
