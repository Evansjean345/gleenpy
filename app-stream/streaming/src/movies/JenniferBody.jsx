...
const ObjTrailer = {
  videoTrailer: "https://media3.giphy.com/media/l0Iy2MXZIZxBNAP4I/giphy.gif",
  title: "Jennifer Body",
  text: `Lorsque le malin prend possession d'elle, Jennifer, une étudiante séduisante, ne voit pas d'un bon oeil les garçons qui n'ont pas tenté leur chance avec elle.`,
  videoModal: "https://www.dailymotion.com/embed/video/xpyda0",
};

const SecondObj = {
  title: "Jennifer Body",
  text: "Écrit par Diablo Cody, le film met en scène une adolescente nommée Jennifer (Megan Fox) qui se retrouve possédée par un succube à la suite d'un sacrifice ayant mal tourné. Elle commence donc à tuer ses camarades de classe masculins pour se nourrir. Sa meilleure amie, Needy (Amanda Seyfried), va alors tenter de l'arrêter.",
};
