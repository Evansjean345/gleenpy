...
const ObjTrailer = {
  videoTrailer:
    "https://i.imgur.com/WDlsv3U.gif",
  title: "Breaking Bad",
  text: ` La série se concentre sur Walter White, un professeur de chimie surqualifié et père de famille .`,
  videoModal:"https://www.dailymotion.com/embed/video/x2kkjq4",
};

const SecondObj = {
  title: "Breaking Bad",
  text: `La série se concentre sur Walter White, un professeur de chimie surqualifié et père de famille, qui, ayant appris qu'il est atteint d'un cancer du poumon en phase terminale, sombre dans le crime pour assurer l'avenir financier de sa famille.
  `,
};
