...
const ObjTrailer = {
  videoTrailer:
    "https://media4.giphy.com/media/tJqyalvo9ahykfykAj/giphy.gif",
  title: "Ricky et Morty",
  text: ` La série suit les mésaventures de Rick Sanchez, un scientifique cynique et fantasque, et de son petit-fils, Morty Smith .`,
  videoModal:"https://www.dailymotion.com/embed/video/x8a2mn3",
};

const SecondObj = {
  title: "Ricky et Morty",
  text: ` La série suit les mésaventures de Rick Sanchez, un scientifique cynique et fantasque, et de son petit-fils, Morty Smith, perturbé et facilement influençable, qui partagent leur temps entre une vie domestique et des aventures interdimensionnelles.
  `,
};
