...
const ObjTrailer = {
  videoTrailer:
    "https://i0.wp.com/media0.giphy.com/media/h8x1BkSDoZW5xMG7GD/giphy.gif?w=1100&ssl=1",
  title: "Sex education",
  text: "Otis, un adolescent puceau qui vit avec sa mère sexologue, est entraîné par la rebelle Maeve dans la création d'une cellule de thérapie sexuelle clandestine au sein de leur lycée.",
  videoModal: "https://www.dailymotion.com/embed/video/x86r93c",
};
    ...
    <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
      <div class="rounded-lg h-64 overflow-hidden">
        <iframe
          ...
          src="https://www.dailymotion.com/embed/video/x8a2qmj" 
  ...
  <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
    <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
      <div class="rounded-lg h-64 overflow-hidden">
        <iframe
          class="rounded-lg h-64 w-full overflow-hidden"
          src="https://www.dailymotion.com/embed/video/x8a1k4u"
          title="too hot to handle"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture ;"
          allowfullscreen="true"
  ...
  <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
    <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
      <div class="rounded-lg h-64 overflow-hidden">
        <iframe
          class="rounded-lg h-64 w-full overflow-hidden"
          src="https://www.dailymotion.com/embed/video/x840ccj"
          title="too hot to handle"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture ;"
          allowfullscreen="true"
            ...
            <div class="flex flex-col">
              ...
              <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                ...
                <p class="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">
                  Le jeune Otis Milburn, dont la mère est thérapeute /
                  sexologue, refuse les questions ou conseils de celle-ci à
                  propos de sa propre sexualité, alors qu'il est vierge et qu'il
                  ne parvient pas à se masturber. Par un concours de
                  circonstances, Otis se retrouve à aider la terreur du lycée,
                  Adam, qui a pour sa part des problèmes d'éjaculation. Témoin
                  de cette thérapie improvisée, Maeve Wiley, une jeune rebelle
                  qui vit sans parents et a des problèmes d'argent, propose à
                  Otis de créer un « cabinet de sexologie » au sein du lycée.
                </p>
              </div>
            </div>
