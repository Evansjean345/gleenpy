...
const ObjTrailer = {
  videoTrailer: "https://thumbs.gfycat.com/EmptyHugeHapuka-max-1mb.gif",
  title: "La chapelle du diable",
  text: `L'histoire d'Alice, une jeune fille malentendante qui, après une supposée manifestation de la Vierge Marie, a regagné de manière inexplicable la capacité d'entendre , de parler et de soigner les malades. `,
  videoModal: "https://www.dailymotion.com/embed/video/x83udnu",
};

const SecondObj = {
  title: "La chapelle du diable",
  text: "Un journaliste en disgrâce se met à enquêter sur une adolescente sourde et muette qui communiquerait avec la vierge Marie et capable de produire des miracles. Cependant, après sa guérison de nombreux évènements étranges se succèdent.",
};

export default function LaChapelle() {
