...
const ObjTrailer = {
  videoTrailer: "https://i.giphy.com/media/5b9mfnart3A9W68laY/giphy.gif",
  title: "L'Exorcisme de Hannah Grace",
  text: `Un épouvantable exorcisme échappe à tout contrôle, coûtant la vie à une jeune femme.`,
  videoModal: "https://www.dailymotion.com/embed/video/x6w4qxt",
};

export default function HannahGrace() {
            ...
            <div class="flex flex-col">
              ...
              <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                ...
                <p class="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">
                  L'ex-policière Megan Reed a perdu son poste à la suite d'une
                  arrestation qui a mal tourné. En cure de désintoxication dans
                  un hôpital de Boston, elle accepte un poste d'agent
                  d'admission dans la morgue de l'établissement. Une nuit, elle
                  reçoit le cadavre de Hannah Grace, une jeune femme décédée
                  trois mois plus tôt à la suite de plusieurs exorcismes ratés.
                  Mais l'esprit démoniaque qui a pris possession de son corps
                  n'a pas disparu et l'amène à commettre plusieurs meurtres qui
                  vont mettre les nerfs de Megan à rude épreuve.
                </p>
              </div>
            </div>
