...
const ObjTrailer = {
  videoTrailer:
    "https://lifemag-ci.com/wp-content/uploads/2020/07/didi.jpg",
  title: "Didi B",
  text: "Tala",
  videoModal: "https://www.youtube-nocookie.com/embed/VHI2QPzlThk"
};
...
const SecondObj = {
  ...
  text: `Paroles
  James Rando Bits!
  Wow, yah! yah, yah-yah, yahhh
  On connait la sauce (abikindâla!)
  On sait comment faire bouger
  Pour ne pas goûter sorcier! (abikindâla)
  Petite mélo, kumambe ndotché fan (dala, dala, dala)
  On est là pour s'enjoyeux
  Et pas le temps de sciencer (dala, dala)
  Tu connait la dance? (bikindâla!)
  Allez dala, dala, dala (dala)
  Tala kudiziki, dala (dala)
  Dala, dala, dala (dala)
  Tala, kumamaku, dala (dala)
  Dala, dala, dala (dala)
  Tala, kudiziki, dala (dala)
  Dala, dala, dala (dala)
  Tala, kumamaku, dala (dala)
