...
const ObjTrailer = {
  ...
  title: "Suspect 95",
  text: "Dans ma tête",
  videoModal:"https://www.youtube-nocookie.com/embed/lIl_zBAFvL0"
};
...
const SecondObj = {
  ...
  text: `Yeah
  Emmanuel Guy
  Au quartier c'est petit Manou, enfant du Val Doyen Cocody
  C'est depuis mon kaki j'ai commencé à bosser sur les flows qui allaient donner tous ces hits sur hits
  Débuté au plus bas de l'échelle jusqu'à ce que j'explose tous les chiffres
Signature DefJam, double nomination MTV
Millionnaire, j'étais comme dans un rêve et puis fiou
12 Décembre 2020, je venais à peine de descendre d'une scène
Maman qui m'appelle toute paniquée, ta femme est à terre donc stop tout faut que tu viennes
Je grille tous les feux Need For Speed, j'arrive en éclair sur les lieux
Et maintenant j'ai la scène sous les yeux
Mon sang s'est glacé quand je l'ai vu étalée, mais c'est trop tard
Ça je savais pas encore, je me suis rendu compte pendant le massage cardiaque
